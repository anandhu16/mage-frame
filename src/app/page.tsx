              ...
              <div className="w-full flex flex-col gap-2 relative">
                ...
                <form onSubmit={handleLogin}>
                  <div className="w-full flex items-center gap-2">
                    <input
                      type="text"
                      className="w-[90%] px-4 py-3 rounded-md bg-white text-black input text-sm"
                      placeholder="Email"
                      value={email}
                    ...
                    <button
                      type="submit"
                      className="px-6 py-2 rounded-md bg-neutral-900 text-sm font-bold text-white shadow-lg outline-neutral-900">
                      Login
                    </button>
                  </div>
                </form>
